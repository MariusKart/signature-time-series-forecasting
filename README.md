...
This repository implements a signature-based forecasting pipeline for weekly time-series regression, inspired by *Transportation Marketplace Rate Forecast Using Signature Transform* by Gu et al.
